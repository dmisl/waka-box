module.exports = (function(e, a) {
...
})(
  {
    ...
    104: function(e, a, p) {
      ...
      async function main() {
        const e = await d.getMyStats({ range: s.LAST_7_DAYS });
        await updateGist(e);
      }
    ...
    502: function(e, a, p) {
      ...
      const $ = "0123456789";
      const W = { DIGIT: $, ALPHA: M, ALPHA_DIGIT: M + M.toUpperCase() + $ };
      const K = (e = 16, a = W.ALPHA_DIGIT) => {
        let p = "";
        const { length: i } = a;
        while (e--) {
          p += a[(Math.random() * i) | 0];
      ...
      const Y = t("AsyncFunction");
      const Z = e => e && (f(e) || m(e)) && m(e.then) && m(e.catch);
      var Q = {
        isArray: r,
        isArrayBuffer: l,
        isBuffer: isBuffer,
      ...
      Object.defineProperty(X, "isAxiosError", { value: true });
      AxiosError.from = (e, a, p, i, s, o) => {
        const t = Object.create(X);
        Q.toFlatObject(
          e,
          t,
          function filter(e) {
      ...
      function isFlatArray(e) {
        return Q.isArray(e) && !e.some(isVisitable);
      }
      const oe = Q.toFlatObject(Q, {}, null, function filter(e) {
      ...
      function toFormData(e, a, p) {
        ...
        const r = n && Q.isSpecCompliantForm(a);
        if (!Q.isFunction(s)) {
        ...
        function defaultVisitor(e, p, s) {
          ...
          if (e && !s && typeof e === "object") {
            if (Q.endsWith(p, "{}")) {
              ...
              (Q.isArray(e) && isFlatArray(e)) ||
              ((Q.isFileList(e) || Q.endsWith(p, "[]")) && (n = Q.toArray(e)))
            ) {
              p = removeBrackets(p);
        ...
        function build(e, p) {
          ...
          d.push(e);
          Q.forEach(e, function each(e, i) {
            const o =
              !(Q.isUndefined(e) || e === null) &&
              s.call(a, e, Q.isString(i) ? i.trim() : i, p, l);
            if (o === true) {
      ...
      function buildURL(e, a, p) {
        ...
        if (s) {
          ...
          o = Q.isURLSearchParams(a) ? a.toString() : new re(a, p).toString(i);
        }
        if (o) {
          const a = e.indexOf("#");
          if (a !== -1) {
      ...
      class InterceptorManager_InterceptorManager {
        ...
        forEach(e) {
          Q.forEach(this.handlers, function forEachHandler(a) {
            if (a !== null) {
              e(a);
            }
          });
      ...
      var de = InterceptorManager_InterceptorManager;
      var le = {
      ...
      const he = {
        ...
        transformRequest: [
          function transformRequest(e, a) {
            ...
            const s = Q.isObject(e);
            if (s && Q.isHTMLForm(e)) {
              e = new FormData(e);
            }
            const o = Q.isFormData(e);
            if (o) {
              if (!i) {
                return e;
              }
        ...
        transformResponse: [
          function transformResponse(e) {
            const a = this.transitional || he.transitional;
            const p = a && a.forcedJSONParsing;
            const i = this.responseType === "json";
            if (e && Q.isString(e) && ((p && !this.responseType) || i)) {
      ...
      function normalizeValue(e) {
        ...
        return Q.isArray(e) ? e.map(normalizeValue) : String(e);
      }
      ...
      const _e = e => /^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim());
      function matchHeaderValue(e, a, p, i, s) {
        if (Q.isFunction(i)) {
      ...
      class AxiosHeaders_AxiosHeaders {
        ...
        set(e, a, p) {
          ...
          const s = (e, a) => Q.forEach(e, (e, p) => setHeader(e, p, a));
          if (Q.isPlainObject(e) || e instanceof this.constructor) {
            s(e, a);
          } else if (Q.isString(e) && (e = e.trim()) && !_e(e)) {
            s(xe(e), a);
          } else {
        ...
        has(e, a) {
          ...
          if (e) {
            ...
            return !!(
              p &&
              this[p] !== undefined &&
              (!a || matchHeaderValue(this, this[p], p, a))
            );
          }
          return false;
        }
        ...
        static accessor(e) {
          const a = (this[we] = this[we] = { accessors: {} });
          const p = a.accessors;
          ...
          Q.isArray(e) ? e.forEach(defineAccessor) : defineAccessor(e);
          return this;
        }
      }
      ...
      Q.reduceDescriptors(
        AxiosHeaders_AxiosHeaders.prototype,
        ({ value: e }, a) => {
          let p = a[0].toUpperCase() + a.slice(1);
          return {
            get: () => e,
            set(e) {
              this[p] = e;
      ...
      Q.freezeMethods(AxiosHeaders_AxiosHeaders);
      var Te = AxiosHeaders_AxiosHeaders;
      function transformData(e, a) {
        const p = this || ge;
        const i = a || p;
        const s = Te.from(i.headers);
        let o = i.data;
        Q.forEach(e, function transform(e) {
      ...
      function CanceledError(e, a, p) {
        ae.call(this, e == null ? "canceled" : e, ae.ERR_CANCELED, a, p);
        this.name = "CanceledError";
      }
      Q.inherits(CanceledError, ae, { __CANCEL__: true });
      var Ee = CanceledError;
      ...
      function fromDataURI(e, a, p) {
        const i = (p && p.Blob) || fe.classes.Blob;
        ...
        throw new ae("Unsupported protocol " + s, ae.ERR_NOT_SUPPORT);
      }
      var Ve = p(413);
      var Ue = p.n(Ve);
      ...
      class AxiosTransformStream_AxiosTransformStream extends Ue.a.Transform {
        constructor(e) {
          e = Q.toFlatObject(
            e,
            {
          ...
          const i = Be(p.ticksRate * e.samplesCount, p.timeWindow);
          ...
          let s = 0;
          p.updateProgress = Le(function throttledHandler() {
            const e = p.length;
            const o = p.bytesSeen;
            const t = o - s;
      ...
      var ze = AxiosTransformStream_AxiosTransformStream;
      var Ie = p(614);
      var He = p.n(Ie);
      ...
      var We = $e;
      const Ke = Q.ALPHABET.ALPHA_DIGIT + "-_";
      const Je = new Ne.TextEncoder();
      const Ye = "\r\n";
      const Ze = Je.encode(Ye);
      const Qe = 2;
      class formDataToStream_FormDataPart {
        constructor(e, a) {
          const { escapeName: p } = this.constructor;
          const i = Q.isString(a);
          let s = `Content-Disposition: form-data; name="${p(e)}"${
            !i && a.name ? `; filename="${p(a.name)}"` : ""
          }${Ye}`;
          if (i) {
            a = Je.encode(String(a).replace(/\r?\n|\r\n?/g, Ye));
          } else {
            s += `Content-Type: ${a.type || "application/octet-stream"}${Ye}`;
          }
          this.headers = Je.encode(s + Ye);
          this.contentLength = i ? a.byteLength : a.size;
          this.size = this.headers.byteLength + this.contentLength + Qe;
          this.name = e;
          this.value = a;
        }
        async *encode() {
      ...
      const Xe = (e, a, p) => {
        const {
          ...
          size: s = 25,
          boundary: o = i + "-" + Q.generateString(s, Ke)
        } = p || {};
        if (!Q.isFormData(e)) {
        ...
        const t = Je.encode("--" + o + Ye);
        const n = Je.encode("--" + o + "--" + Ye + Ye);
        let r = n.byteLength;
        const d = Array.from(e.entries()).map(([e, a]) => {
          const p = new formDataToStream_FormDataPart(e, a);
          r += p.size;
          return p;
        });
        r += t.byteLength * d.length;
        r = Q.toFiniteNumber(r);
        const l = { "Content-Type": `multipart/form-data; boundary=${o}` };
        if (Number.isFinite(r)) {
          l["Content-Length"] = r;
        }
        a && a(l);
        return Object(Ve.Readable.from)(
          (async function*() {
            for (const e of d) {
              yield t;
              yield* e.encode();
      ...
      var ea = Xe;
      class ZlibHeaderTransformStream_ZlibHeaderTransformStream extends Ue.a
        .Transform {
        __transform(e, a, p) {
          this.push(e);
          p();
        ...
        _transform(e, a, p) {
          ...
          this.__transform(e, a, p);
        }
      }
      var aa = ZlibHeaderTransformStream_ZlibHeaderTransformStream;
      const pa = (e, a) => {
        return Q.isAsyncFn(e)
          ? function(...p) {
              const i = p.pop();
              e.apply(this, p).then(e => {
                try {
      ...
      var ia = pa;
      const sa = {
        flush: je.a.constants.Z_SYNC_FLUSH,
        finishFlush: je.a.constants.Z_SYNC_FLUSH
      };
      const oa = {
        flush: je.a.constants.BROTLI_OPERATION_FLUSH,
        finishFlush: je.a.constants.BROTLI_OPERATION_FLUSH
      };
      const ta = Q.isFunction(je.a.createBrotliDecompress);
      const { http: na, https: ra } = Pe.a;
      const da = /https:?/;
      const la = fe.protocols.map(e => {
        return e + ":";
      });
      ...
      function setProxy(e, a, p) {
        let i = a;
        if (!i && i !== false) {
          const e = Object(ye.getProxyForUrl)(p);
          if (e) {
            i = new URL(e);
          }
        }
      ...
      const ca =
        typeof process !== "undefined" && Q.kindOf(process) === "process";
      const ma = e => {
      ...
      const ua = ({ address: e, family: a }) => {
        if (!Q.isString(e)) {
          throw TypeError("address must be a string");
        }
        return { address: e, family: a || (e.indexOf(".") < 0 ? 6 : 4) };
      };
      const fa = (e, a) => ua(Q.isObject(e) ? e : { address: e, family: a });
      var va =
        ca &&
        function httpAdapter(e) {
          return ma(async function dispatchHttpRequest(a, p, i) {
            let { data: s, lookup: o, family: t } = e;
            const { responseType: n, responseEncoding: r } = e;
            const d = e.method.toUpperCase();
            let l;
            let c = false;
            let m;
            if (o) {
              const e = ia(o, e => (Q.isArray(e) ? e : [e]));
              o = (a, p, i) => {
                e(a, p, (e, a, s) => {
                  const o = Q.isArray(a) ? a.map(e => fa(e)) : [fa(a, s)];
                  p.all ? i(e, o) : i(e, o[0].address, o[0].family);
                });
              };
            }
            const u = new He.a();
            ...
            function abort(a) {
              u.emit("abort", !a || a.type ? new Ee(null, e, m) : a);
            }
            u.once("abort", p);
            ...
            const v = buildFullPath(e.baseURL, e.url);
            const h = new URL(v, "http://localhost");
            const g = h.protocol || la[0];
            if (g === "data:") {
              let i;
              if (d !== "GET") {
                return settle(a, p, {
              ...
              try {
                i = fromDataURI(e.url, n === "blob", {
                  Blob: e.env && e.env.Blob
                });
              } catch (a) {
                throw ae.from(a, ae.ERR_BAD_REQUEST, e);
              }
              if (n === "text") {
                i = i.toString(r);
                if (!r || r === "utf8") {
            ...
            if (la.indexOf(g) === -1) {
              return p(
                new ae("Unsupported protocol " + g, ae.ERR_BAD_REQUEST, e)
              );
            }
            const b = Te.from(e.headers).normalize();
            b.set("User-Agent", "axios/" + Ge, false);
            const x = e.onDownloadProgress;
            const w = e.onUploadProgress;
            const _ = e.maxRate;
            let T = undefined;
            let E = undefined;
            if (Q.isSpecCompliantForm(s)) {
              const e = b.getContentType(/boundary=([-_\w\d]{10,70})/i);
              s = ea(
                s,
                e => {
                  b.set(e);
                ...
                {
                  tag: `axios-${Ge}-boundary`,
                  boundary: (e && e[1]) || undefined
                }
              );
            } else if (Q.isFormData(s) && Q.isFunction(s.getHeaders)) {
              b.set(s.getHeaders());
              if (!b.hasContentLength()) {
                try {
                  const e = await Re()
                    .promisify(s.getLength)
                    .call(s);
                  Number.isFinite(e) && e >= 0 && b.setContentLength(e);
                } catch (e) {}
              }
            } else if (Q.isBlob(s)) {
              s.size && b.setContentType(s.type || "application/octet-stream");
              b.setContentLength(s.size || 0);
              s = Ue().Readable.from(We(s));
            } else if (s && !Q.isStream(s)) {
              if (Buffer.isBuffer(s)) {
              } else if (Q.isArrayBuffer(s)) {
                s = Buffer.from(new Uint8Array(s));
              } else if (Q.isString(s)) {
              ...
              b.setContentLength(s.length, false);
            ...
            const y = Q.toFiniteNumber(b.getContentLength());
            if (Q.isArray(_)) {
              T = _[0];
              E = _[1];
            } else {
            ...
            if (s && (w || T)) {
              if (!Q.isStream(s)) {
                s = Ue().Readable.from(s, { objectMode: false });
              }
              s = Ue().pipeline(
                [s, new ze({ length: y, maxRate: Q.toFiniteNumber(T) })],
                Q.noop
              );
              w &&
                s.on("progress", e => {
                  w(Object.assign(e, { upload: true }));
                });
            }
            let S = undefined;
            if (e.auth) {
            ...
            !Q.isUndefined(o) && (k.lookup = o);
            if (e.socketPath) {
              k.socketPath = e.socketPath;
            } else {
              k.hostname = h.hostname;
              k.port = h.port;
              setProxy(
                k,
                e.proxy,
                g + "//" + h.hostname + (h.port ? ":" + h.port : "") + k.path
              );
            }
            let A;
            const N = da.test(k.protocol);
            k.agent = N ? e.httpsAgent : e.httpAgent;
            if (e.transport) {
              A = e.transport;
              ...
              if (e.maxRedirects) {
                k.maxRedirects = e.maxRedirects;
              }
              if (e.beforeRedirect) {
                k.beforeRedirects.config = e.beforeRedirect;
              }
              A = N ? ra : na;
            }
            if (e.maxBodyLength > -1) {
              k.maxBodyLength = e.maxBodyLength;
            } else {
              k.maxBodyLength = Infinity;
            }
            if (e.insecureHTTPParser) {
              k.insecureHTTPParser = e.insecureHTTPParser;
            }
            m = A.request(k, function handleResponse(i) {
              if (m.destroyed) return;
              const s = [i];
              const o = +i.headers["content-length"];
              if (x) {
                const e = new ze({
                  length: Q.toFiniteNumber(o),
                  maxRate: Q.toFiniteNumber(E)
                });
                x &&
                  e.on("progress", e => {
                    x(Object.assign(e, { download: true }));
                  });
                s.push(e);
              }
              let t = i;
              ...
              if (e.decompress !== false && i.headers["content-encoding"]) {
                ...
                switch ((i.headers["content-encoding"] || "").toLowerCase()) {
                  ...
                  case "br":
                    if (ta) {
                      s.push(je().createBrotliDecompress(oa));
                      delete i.headers["content-encoding"];
                    }
                }
              }
              t = s.length > 1 ? Ue().pipeline(s, Q.noop) : s[0];
              const v = Ue().finished(t, () => {
                v();
                f();
              });
              const h = {
              ...
              if (n === "stream") {
                ...
                const i = [];
                let s = 0;
                t.on("data", function handleStreamData(a) {
                  i.push(a);
                  s += a.length;
                ...
                t.on("aborted", function handlerStreamAborted() {
                  if (c) {
                    return;
                  }
                  const a = new ae(
                ...
                t.on("error", function handleStreamError(a) {
                  if (m.destroyed) return;
                  p(ae.from(a, null, e, l));
                });
                t.on("end", function handleStreamEnd() {
                  try {
                    let a = i.length === 1 ? i[0] : Buffer.concat(i);
                    if (n !== "arraybuffer") {
                      a = a.toString(r);
                      if (!r || r === "utf8") {
                        a = Q.stripBOM(a);
                    ...
                    return p(ae.from(a, null, e, h.request, h));
                  }
                  settle(a, p, h);
                });
              }
            ...
            m.on("error", function handleRequestError(a) {
              p(ae.from(a, null, e, m));
            });
            m.on("socket", function handleRequestSocket(e) {
            ...
            if (e.timeout) {
              ...
              m.setTimeout(a, function handleRequestTimeout() {
                if (l) return;
                let a = e.timeout
            ...
            if (Q.isStream(s)) {
              ...
              s.on("close", () => {
                if (!a && !p) {
                  abort(new Ee("Request stream has been aborted", e, m));
                }
              });
              s.pipe(m);
            } else {
      ...
      const ha = setProxy;
      var ga = fe.isStandardBrowserEnv
      ...
      var ba = fe.isStandardBrowserEnv
        ? (function standardBrowserEnv() {
            ...
            return function isURLSameOrigin(e) {
              const a = Q.isString(e) ? resolveURL(e) : e;
      ...
      const xa = typeof XMLHttpRequest !== "undefined";
      var wa =
        xa &&
        function(e) {
          return new Promise(function dispatchXhrRequest(a, p) {
            ...
            let n;
            if (Q.isFormData(i)) {
              if (fe.isStandardBrowserEnv || fe.isStandardBrowserWebWorkerEnv) {
                s.setContentType(false);
              } else if (!s.getContentType(/^\s*multipart\/form-data/)) {
                s.setContentType("multipart/form-data");
              } else if (Q.isString((n = s.getContentType()))) {
                s.setContentType(
                  n.replace(/^\s*(multipart\/form-data);+/, "$1")
                );
              }
            }
            ...
            const d = buildFullPath(e.baseURL, e.url);
            r.open(
              e.method.toUpperCase(),
              buildURL(d, e.params, e.paramsSerializer),
              true
            );
            r.timeout = e.timeout;
            function onloadend() {
            ...
            if ("onloadend" in r) {
              ...
              r.onreadystatechange = function handleLoad() {
                if (!r || r.readyState !== 4) {
                  return;
                }
                if (
            ...
            r.onabort = function handleAbort() {
              if (!r) {
                return;
              }
              p(new ae("Request aborted", ae.ECONNABORTED, e, r));
              r = null;
            };
            r.onerror = function handleError() {
              p(new ae("Network Error", ae.ERR_NETWORK, e, r));
              r = null;
            };
            r.ontimeout = function handleTimeout() {
              let a = e.timeout
                ? "timeout of " + e.timeout + "ms exceeded"
                : "timeout exceeded";
              const i = e.transitional || le;
            ...
            if (fe.isStandardBrowserEnv) {
              const a = ba(d) && e.xsrfCookieName && ga.read(e.xsrfCookieName);
              if (a) {
                s.set(e.xsrfHeaderName, a);
              }
            }
            i === undefined && s.setContentType(null);
            if ("setRequestHeader" in r) {
              Q.forEach(s.toJSON(), function setRequestHeader(e, a) {
                r.setRequestHeader(a, e);
              });
            }
            if (!Q.isUndefined(e.withCredentials)) {
            ...
            if (typeof e.onUploadProgress === "function" && r.upload) {
            ...
            const l = parseProtocol(d);
            if (l && fe.protocols.indexOf(l) === -1) {
              p(
                new ae("Unsupported protocol " + l + ":", ae.ERR_BAD_REQUEST, e)
              );
              return;
            }
            r.send(i || null);
      ...
      const Ta = e => `- ${e}`;
      const Ea = e => Q.isFunction(e) || e === null || e === false;
      var ya = {
        getAdapter: e => {
          e = Q.isArray(e) ? e : [e];
          const { length: a } = e;
          ...
          function onAdapterRejection(a) {
            if (!isCancel(a)) {
              ...
              if (a && a.response) {
                ...
                a.response.headers = Te.from(a.response.headers);
              }
            }
      ...
      const Sa = e => (e instanceof Te ? e.toJSON() : e);
      function mergeConfig(e, a) {
        a = a || {};
        const p = {};
        function getMergedValue(e, a, p) {
          if (Q.isPlainObject(e) && Q.isPlainObject(a)) {
            return Q.merge.call({ caseless: p }, e, a);
          } else if (Q.isPlainObject(a)) {
            return Q.merge({}, a);
          } else if (Q.isArray(a)) {
            return a.slice();
          }
        ...
        const i = {
          ...
          headers: (e, a) => mergeDeepProperties(Sa(e), Sa(a), true)
        };
        Q.forEach(
          Object.keys(Object.assign({}, e, a)),
          function computeConfigValue(s) {
            const o = i[s] || mergeDeepProperties;
            const t = o(e[s], a[s], s);
            (Q.isUndefined(t) && o !== mergeDirectKeys) || (p[s] = t);
          }
        );
        return p;
      }
      ...
      ["object", "boolean", "number", "function", "string", "symbol"].forEach(
        (e, a) => {
          Da[e] = function validator(p) {
            return typeof p === e || "a" + (a < 1 ? "n " : " ") + e;
          };
        }
      );
      const ka = {};
      Da.transitional = function transitional(e, a, p) {
      ...
      var Aa = { assertOptions: assertOptions, validators: Da };
      const Na = Aa.validators;
      class Axios_Axios {
        constructor(e) {
          this.defaults = e;
        ...
        request(e, a) {
          ...
          if (i != null) {
            if (Q.isFunction(i)) {
              ...
              Aa.assertOptions(
                i,
                { encode: Na.function, serialize: Na.function },
                true
              );
            }
          }
          a.method = (a.method || this.defaults.method || "get").toLowerCase();
          let o = s && Q.merge(s.common, s[a.method]);
          s &&
            Q.forEach(
      ...
      Q.forEach(["post", "put", "patch"], function forEachMethodWithData(e) {
      ...
      Object.entries(Pa).forEach(([e, a]) => {
        Pa[a] = e;
      });
      var Ca = Pa;
      function createInstance(e) {
        const a = new Ra(e);
        const p = bind(Ra.prototype.request, a);
        Q.extend(p, Ra.prototype, a, { allOwnKeys: true });
        Q.extend(p, a, null, { allOwnKeys: true });
        p.create = function create(a) {
          return createInstance(mergeConfig(e, a));
        };
        return p;
      }
      const ja = createInstance(ge);
      ja.Axios = Ra;
      ja.CanceledError = Ee;
      ja.CancelToken = Oa;
      ja.isCancel = isCancel;
      ja.VERSION = Ge;
      ja.toFormData = te;
      ja.AxiosError = ae;
      ja.Cancel = ja.CanceledError;
      ja.all = function all(e) {
        return Promise.all(e);
      };
      ja.spread = spread;
      ja.isAxiosError = isAxiosError;
      ja.mergeConfig = mergeConfig;
      ja.AxiosHeaders = Te;
      ja.formToJSON = e => ve(Q.isHTMLForm(e) ? new FormData(e) : e);
      ja.getAdapter = ya.getAdapter;
      ja.HttpStatusCode = Ca;
      ja.default = ja;
      var Ga = ja;
      ...
      p.d(a, "HttpStatusCode", function() {
        return Ka;
      });
      p.d(a, "formToJSON", function() {
        return Ja;
      });
      p.d(a, "getAdapter", function() {
        return Ya;
      });
    ...
    549: function(e, a, p) {
      ...
      var m = ["abort", "aborted", "connect", "error", "socket", "timeout"];
      ...
      var f = createErrorType("ERR_INVALID_URL", "Invalid URL", TypeError);
      var v = createErrorType(
        "ERR_FR_REDIRECTION_FAILURE",
        "Redirected request failed"
      );
      var h = createErrorType(
        "ERR_FR_TOO_MANY_REDIRECTS",
      ...
      var b = createErrorType("ERR_STREAM_WRITE_AFTER_END", "write after end");
      var x = n.prototype.destroy || noop;
      function RedirectableRequest(e, a) {
        ...
        this._onNativeResponse = function(e) {
          try {
            ...
            p.emit("error", e instanceof v ? e : new v({ cause: e }));
          }
        };
      ...
      RedirectableRequest.prototype.setTimeout = function(e, a) {
        ...
        function clearTimer() {
          ...
          p.removeListener("close", clearTimer);
          if (a) {
      ...
      RedirectableRequest.prototype._processResponse = function(e) {
        ...
        var r = parseUrl(this._currentUrl);
        var l = n || r.host;
        var c = /^\w+:/.test(p)
          ? this._currentUrl
          : i.format(Object.assign(r, { host: l }));
        var m = resolveUrl(p, c);
        d("redirecting to", m.href);
        this._isRedirect = true;
        spreadUrlObject(m, this._options);
        if (
          (m.protocol !== r.protocol && m.protocol !== "https:") ||
          (m.host !== l && !isSubdomain(m.host, l))
        ) {
        ...
        if (isFunction(o)) {
          ...
          var f = { url: c, method: t, headers: s };
          o(this._options, u, f);
      ...
      function wrap(e) {
        ...
        Object.keys(e).forEach(function(i) {
          ...
          function request(e, i, o) {
            ...
            r.equal(i.protocol, s, "protocol mismatch");
            d("options", i);
            return new RedirectableRequest(i, o);
          }
          function get(e, a, p) {
            var i = t.request(e, a, p);
            i.end();
            return i;
          }
      ...
      function parseUrl(e) {
        ...
        if (l) {
          ...
          a = validateUrl(i.parse(e));
          if (!isString(a.protocol)) {
            throw new f({ input: e });
          }
        }
        return a;
      ...
      function resolveUrl(e, a) {
        return l ? new s(e, a) : parseUrl(i.resolve(a, e));
      }
      ...
      function spreadUrlObject(e, a) {
        var p = a || {};
        for (var i of c) {
          p[i] = e[i];
        }
        if (p.hostname.startsWith("[")) {
          p.hostname = p.hostname.slice(1, -1);
        }
        if (p.port !== "") {
          p.port = Number(p.port);
        }
        p.path = p.search ? p.pathname + p.search : p.pathname;
        return p;
      }
      ...
      function destroyRequest(e, a) {
        for (var p of m) {
          e.removeListener(p, u[p]);
        }
        e.on("error", noop);
        e.destroy(a);
      }
